...
public class AdminMenuController {
    ...
    public ResponseEntity<ListSuccessResponse<CategorySelectedResponseDto>> getSelectedCategories() {
        ...
        List<CategorySelectedResponseDto> categories =
                adminMenuService.getSelectedCategories();

        ListSuccessResponse<CategorySelectedResponseDto> response =
                new ListSuccessResponse<>(
                        LocalDateTime.now(),
                        "Selected categories fetched successfully",
                        categories
                );
    ...
    public ResponseEntity<ListSuccessResponse<ItemResponseDto>> getItemsByCategorySelectedId(
        ...
        List<ItemResponseDto> items =
                adminMenuService.getItemsByCategorySelectedId(categorySelectedId);
